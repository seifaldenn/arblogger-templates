 ...
 *	
 *	Copyleft (c) 2011 Fred Heusschen
 *	www.frebsite.nl
 * 
 *      Translated By : www.arblogger-templates.com
 *
...
(function($) {
	...
	$.fn.carouFredSel = function(o) {
		...
		$cfs.init = function(o, setOrig, start) {
			...
			conf.direction = (opts.direction == 'up' || opts.direction == 'right') ? 'next' : 'prev';
		...
		$cfs.bind_events = function() {
			...
			$cfs.bind('slide_next.cfs'+serial, function(e, sO, nI) {
				...
				if (opts.usePadding) {
					a_old[opts.d['marginleft']] = l_old.data('cfs_origCssMargin');
					a_cur[opts.d['marginleft']] = l_cur.data('cfs_origCssMargin') + opts.padding[opts.d[3]];
					l_new.css(opts.d['marginleft'], l_new.data('cfs_origCssMargin') + opts.padding[opts.d[1]]);
					l_old.stop().animate(a_old, a_conf);
					l_cur.stop().animate(a_cur, a_conf);
				}
	...
	function resetMargin(i, o, m) {
		...
		i.each(function() {
			var t = parseInt($(this).css(o.d['marginleft']));
			if (isNaN(t)) t = 0;
			$(this).data('cfs_tempCssMargin', t);
			$(this).css(o.d['marginleft'], ((x) ? $(this).data('cfs_tempCssMargin') : m + $(this).data('cfs_origCssMargin')));
		});
	}
	...
	function setSizes($c, o, p) {
		...
		if (o.usePadding) {
			var $l = $v.last();
			$l.css(o.d['marginleft'], $l.data('cfs_origCssMargin') + o.padding[o.d[1]]);
			$c.css(o.d['top'], o.padding[o.d[0]]);
			$c.css(o.d['right'], o.padding[o.d[3]]);
		}
